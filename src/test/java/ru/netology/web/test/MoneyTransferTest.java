...
//    val loginPage = new LoginPageV2();
    ...
    val verificationPage = loginPage.validLogin(authInfo);
    val verificationCode = DataHelper.getVerificationCodeFor(authInfo);
    val addingMoneyPage = verificationPage.validVerify(verificationCode);
    val dashboardPage = addingMoneyPage.getValidDashboardPage();
    val moneyTransferPage = dashboardPage.validTransfer()
